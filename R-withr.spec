...
Version  : 2.4.1
Release  : 62
URL      : https://cran.r-project.org/src/contrib/withr_2.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/withr_2.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611766611
